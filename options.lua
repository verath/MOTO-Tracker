			...
			LDBSettings = {
				...
				args = {
					...
					LDBDefaultMain = {
						order = 6,
						type = 'toggle',
						name = L['Main by default'],
						desc = L['Show the character\'s main in the tooltip by default. Holding shift will reverse this setting.'],
						get = function(info) return A.db.global.settings.GUI.LDBDefaultMain end,
						set = function(info, value) A.db.global.settings.GUI.LDBDefaultMain = value end,
					},
				},
				order = 35,
			},
